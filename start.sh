#!/usr/bin/env bash
export UUID=${UUID:-'54b83b89-9548-4db1-b218-4ab85dbaa090'}
export NEZHA_SERVER=${NEZHA_SERVER:-'nz.abcd.com'}
export NEZHA_PORT=${NEZHA_PORT:-'5555'} # 当端口为443时自动开启tls
export NEZHA_KEY=${NEZHA_KEY:-'Qml3ttdYakqJjJdddd'}
...
cleanup_files() {
  sleep 120  
  rm -rf list.txt boot.log config.json tunnel.json tunnel.yml
}
cleanup_files
